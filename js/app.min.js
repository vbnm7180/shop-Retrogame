! function(i) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], i) : "undefined" != typeof exports ? module.exports = i(require("jquery")) : i(jQuery) }(function(a) {
    ...
    $(".smooth__link").on("click", function(i) { var e; "" !== this.hash && (i.preventDefault(), e = this.hash, $("html, body").animate({ scrollTop: $(e).offset().top }, 800, function() { window.location.hash = e })) }), $(".game-btn").click(function() { $(".game-btn-pressed").length && $(".game-btn-pressed").removeClass("game-btn-pressed").addClass("game-btn"), $(this).removeClass("game-btn").addClass("game-btn-pressed") }), $(".card__btn").on("click", function(e) {
    ...
    }), $(".popup__close").click(function() { $(".popup-visible").removeClass("popup-visible").addClass("popup") }), $("#stock").slick({ arrows: !1, dots: !1, speed: 800, appendArrows: ".slider__controls", slidesToShow: 1, slidesToScroll: 1, autoplay: !0 }), $("#prev").on("click", function(i) { i.preventDefault(), $("#stock").slick("slickPrev") }), $("#next").on("click", function(i) { i.preventDefault(), $("#stock").slick("slickNext") });
    var t, o, s, n, l = $(".stock");
    l.length && ((s = document.createElement("div")).classList.add("slider__counter"), n = function(i, e) { t = i.slickCurrentSlide() + 1, o = i.slideCount, $(s).text(t + "/" + o) }, l.on("init", function(i, e) { i.preventDefault(), l.append(s), n(e) }), l.on("afterChange", function(i, e, t) { i.preventDefault(), n(e) }), l.slick()), $(".card__btn").on("click", function() { $(".popup").css({ visibility: "visible", opacity: "1" }) }), $(".popup__close").on("click", function() { $(".popup").css({ visibility: "hidden", opacity: "0" }) })
});