<footer class="footer">
        <div class="container">
            <div class="footer__row">
                <div class="footer__column">
                    <div class="contacts__footer item1">
                        <div class="footer__mail">
                            Электронная почта: <br>retrogame@gmail.com
                        </div>
                ...
                <div class="footer__column">
                    <div class="footer__link__terms item1">
                        ...
                        <a href="#" class="footer_link">Соглашение на обработку данных</a>
            ...
            <div class="footer__row2">
                <p class="footer__text">© 2020 retro-game.com  Все права защищены.</p>
            </div>
        </div>
    </footer>    </div>
