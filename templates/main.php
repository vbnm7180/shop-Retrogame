        ...
        <div class="popup" id="popup-nintendo-64">
                <div class="popup__body">
                    <div class="popup__content">
                        <div class="popup__main-text"><span class="popup__console-name">nintendo 64</span> Товары в наличии</div>
                        <button type="button" class="popup__close"><img src="/images/popup/popup_close.png" alt="quit" class="popup__close-img"></button>
                        <div class="popup__card">
                            <div class="popup__img"><img src="/images/popup/popup_1.png" alt="" class="popup-img"></div>
                            <div class="popup__title">
                                <h3>NINTENDO 64 (BOX)</h3>
                            </div>
                            <div class="popup__text">Состояние: 5<br>Новая консоль c коробкой без повреждений и царапин<br> Комплект: Консоль, 2 геймпада, блок питания, документация<br> Регион: PAL-Европа<br> Цена 14.990 (знак рубля)
                            </div>
                            <a href="#" class="btn popap-btn">Добавить в Корзину</a>
                        </div>
                        <div class="popup__card">
                            <div class="popup__img"><img src="/images/popup/popup_1.png" alt="" class="popup-img"></div>
                            <div class="popup__title">
